...
DB_CONTAINER_NAME="mjc-web-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=mjc-web -d -p 5432:5432 docker.io/postgres
